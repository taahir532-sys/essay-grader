...
FREE_LIMIT = 10
st.set_page_config(page_title="TEFLMate v6.91 - Class Portfolio", page_icon="📚", layout="wide", initial_sidebar_state="expanded")
st.markdown("""
<style>
...
# CLEAN TABS - Only 6, no text above - v6.91
...
st.markdown("---")
st.markdown("<div style='text-align:center; padding:12px; font-weight:600; color:#555;'>© 2026 TEFLMate v6.91 | Made in Durban, ZA | OCR: qwen2.5-vl-32b-instruct</div>", unsafe_allow_html=True)
