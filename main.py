...
def create_branded_pdf(original_essay, ai_result, target_level):
    ...
    # Take first 300 chars of AI result for box
    ...
    pdf.set_font("Arial", '', 9)
    pdf.set_text_color(255,255,255)
    pdf.cell(0, 8, "Generated by TEFL Grader Pro - beacons.ai/mr_mahomed - English Toolkit Creator")
